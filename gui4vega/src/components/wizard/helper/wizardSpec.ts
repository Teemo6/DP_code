...
import { BarVerticalAdapter } from "../adapters/template/simple/BarVerticalAdapter.ts";
import { BarHorizontalAdapter } from "../adapters/template/simple/BarHorizontalAdapter.ts";
import { BarStackedAdapter } from "../adapters/template/stacked/BarStackedAdapter.ts";
import { BarGroupedAdapter } from "../adapters/template/stacked/BarGroupedAdapter.ts";
import { PieAdapter } from "../adapters/template/simple/PieAdapter.ts";
import { ScatterAdapter } from "../adapters/template/simple/ScatterAdapter.ts";
import { SpiderAdapter } from "../adapters/template/stacked/SpiderAdapter.ts";
import { AreaAdapter } from "../adapters/template/simple/AreaAdapter.ts";
import { AreaStackedAdapter } from "../adapters/template/stacked/AreaStackedAdapter.ts";
